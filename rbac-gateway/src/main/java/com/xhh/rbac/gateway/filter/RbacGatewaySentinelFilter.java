...
import com.xhh.rbac.gateway.fallback.RbacGatewayBlockFallbackProvider;
...
@Slf4j
@Configuration
public class RbacGatewaySentinelFilter {
    ...
    @PostConstruct
    public void doInit() {
        ZuulBlockFallbackManager.registerProvider(new RbacGatewayBlockFallbackProvider());
        initGatewayRules();
    }
